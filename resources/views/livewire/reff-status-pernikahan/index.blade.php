<div>
    <div class="mb-4 flex flex-wrap items-center justify-between gap-2">
        <h2 class="text-xl font-semibold text-gray-800">Referensi Status Pernikahan</h2>
        <a href="{{ route('reff-status-pernikahan.create') }}" class="px-3 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700">+ Tambah</a>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <a href="{{ route('reff-status-pernikahan.edit', $item->id) }}" class="text-blue-600 hover:underline text-sm">Ubah</a>
