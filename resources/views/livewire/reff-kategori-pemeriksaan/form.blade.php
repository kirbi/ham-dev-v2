<div class="max-w-2xl">
    <div class="mb-4">
        <h2 class="text-xl font-semibold text-gray-800">{{ $kategori_pemeriksaan_id ? 'Edit' : 'Tambah' }} Kategori Pemeriksaan</h2>
    </div>
    <div class="bg-white rounded-lg shadow p-6">
        <form wire:submit.prevent="save">
            ...
            <div class="mb-5">
                ...
                <input type="number" wire:model="urutan" min="1" class="w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('urutan') border-red-500 @enderror">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('reff-kategori-pemeriksaan.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 text-sm rounded-lg hover:bg-gray-200">Batal</a>
            </div>
        </form>
    </div>
</div>
