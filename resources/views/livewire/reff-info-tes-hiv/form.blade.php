<div>
    <h2 class="text-xl font-bold mb-4">{{ $id_info_tes_hiv ? 'Edit' : 'Tambah' }} Info Tes HIV</h2>
    ...
    <form wire:submit.prevent="save" class="max-w-lg">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('reff-info-tes-hiv.index') }}" class="px-4 py-2 rounded border hover:bg-gray-100">Batal</a>
        </div>
    </form>
</div>
