<div>
    <h2 class="text-xl font-bold mb-4">{{ $id_status_fungsional ? 'Edit' : 'Tambah' }} Status Fungsional</h2>
    <form wire:submit.prevent="save">
        ...
        <div class="mb-4">
            ...
            <input type="text" wire:model="kode" class="border rounded px-2 py-1 w-full" />
        </div>
        <div class="mb-4">
        ...
        <a href="{{ route('reff-status-fungsional.index') }}" class="ml-2 text-gray-600">Batal</a>
    </form>
</div>
