<div>
    <div class="mb-4 flex flex-wrap items-center justify-between gap-2">
        <h2 class="text-xl font-semibold text-gray-800">Referensi Mitra Seksual</h2>
        <a href="{{ route('reff-mitra-seksual.create') }}" class="px-3 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700">+ Tambah</a>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <a href="{{ route('reff-mitra-seksual.edit', $item->id_mitra_seksual) }}" class="text-blue-600 hover:underline text-sm">Ubah</a>
                            <button wire:click="delete({{ $item->id_mitra_seksual }})" wire:confirm="Yakin ingin menghapus data ini?" class="text-red-600 hover:underline text-sm ml-2">Hapus</button>
                        </td>
                    </tr>
                    @empty
