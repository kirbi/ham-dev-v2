<div>
    <h2 class="text-xl font-bold mb-4">{{ $id_tempat_terapi ? 'Edit' : 'Tambah' }} Tempat Terapi</h2>
    ...
    <form wire:submit.prevent="save" class="max-w-lg">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('reff-tempat-terapi.index') }}" class="px-4 py-2 rounded border hover:bg-gray-100">Batal</a>
        </div>
    </form>
</div>
