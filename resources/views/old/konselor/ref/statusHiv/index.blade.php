            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h2>STATUS HIV <i class="fas fa-plus"> </i> </h2>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_status_hiv" id="id_status_hiv">
...
$(function () {
     ...
     $('body').on('click', '.editProduct', function () {
         var id_status_hiv = $(this).data('id');
         $.get("{{ route('statusHiv.index') }}" +'/' + id_status_hiv +'/edit', function (data) {
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('statusHiv.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
