            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_tempat_terapi" id="id_tempat_terapi">
...
$(function () {
     ...
     $('body').on('click', '.editProduct', function () {
         var id_tempat_terapi = $(this).data('id');
         $.get("{{ route('tempatTerapi.index') }}" +'/' + id_tempat_terapi +'/edit', function (data) {
             $('#modelHeading').html("Ubah Data");
             $('#saveBtn').val("edit-user");
             $('#ajaxModel').modal('show');
             $('#nama').val(data.nama);
             $('#id_tempat_terapi').val(data.id_tempat_terapi);
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('tempatTerapi.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
