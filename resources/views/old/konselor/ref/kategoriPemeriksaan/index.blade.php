            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h2>Kategori Pemeriksaan Klinis</h2>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_kategori_pemeriksaan" id="id_kategori_pemeriksaan">
                        ...
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">Urutan</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="urutan" name="urutan" placeholder="1" value="" maxlength="250" required="" type="number">
                            </div>
                        </div>
...
$(function () {
     ...
     var table = $('.data-table').DataTable({
         processing: true,
         serverSide: true,
         ajax: "{{ route('kategoriPemeriksaan.index') }}",
         columns: [
     ...
     $('body').on('click', '.editProduct', function () {
         var id_kategori_pemeriksaan = $(this).data('id');
         $.get("{{ route('kategoriPemeriksaan.index') }}" +'/' + id_kategori_pemeriksaan +'/edit', function (data) {
     ...
     $('#saveBtn').click(function (e) {
         ...
         $.ajax({
             ...
             url: "{{ route('kategoriPemeriksaan.store') }}",
             type: "POST",
             dataType: 'json',
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('kategoriPemeriksaan.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
