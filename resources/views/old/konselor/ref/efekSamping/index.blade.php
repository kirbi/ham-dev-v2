            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_efek_samping" id="id_efek_samping">
...
$(function () {
     ...
     $('body').on('click', '.editProduct', function () {
         var id_efek_samping = $(this).data('id');
         console.log(id_efek_samping);
         $.get("{{ route('efekSamping.index') }}" +'/' + id_efek_samping +'/edit', function (data) {
             $('#modelHeading').html("Ubah Data");
             $('#saveBtn').val("edit-user");
             $('#ajaxModel').modal('show');
             $('#nama').val(data.nama);
             $('#id_efek_samping').val(data.id_efek_samping);
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('efekSamping.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
