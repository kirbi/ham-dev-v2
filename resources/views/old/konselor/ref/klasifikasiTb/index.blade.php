            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_tipe_tb" id="id_tipe_tb">
...
$(function () {
     ...
     var table = $('.data-table').DataTable({
         processing: true,
         serverSide: true,
         ajax: "{{ route('klasifikasiTb.index') }}",
         columns: [
     ...
     $('body').on('click', '.editProduct', function () {
         var id_tipe_tb = $(this).data('id');
         $.get("{{ route('klasifikasiTb.index') }}" +'/' + id_tipe_tb +'/edit', function (data) {
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('klasifikasiTb.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
