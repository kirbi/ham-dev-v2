            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_tingkat_resiko_hiv" id="id_tingkat_resiko_hiv">
...
$(function () {
     ...
     var table = $('.data-table').DataTable({
         processing: true,
         serverSide: true,
         ajax: "{{ route('tingkatResikoHiv.index') }}",
         columns: [
     ...
     $('body').on('click', '.editProduct', function () {
         var id_tingkat_resiko_hiv = $(this).data('id');
         $.get("{{ route('tingkatResikoHiv.index') }}" +'/' + id_tingkat_resiko_hiv +'/edit', function (data) {
     ...
     $('#saveBtn').click(function (e) {
         ...
         $.ajax({
             ...
             url: "{{ route('tingkatResikoHiv.store') }}",
             type: "POST",
             dataType: 'json',
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('tingkatResikoHiv.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
