                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row dflex justify-content-center">
                            <h5>Tambah Data Follow Up Pasien "{{$data->pasien->nama}}"</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <form id="followUpForm" name="followUpForm" class="form-horizontal">
                            ...
                            <input type="hidden" name="id_riwayat_perawatan_pasien" id="id_riwayat_perawatan_pasien" value="{{$data->id_riwayat_perawatan_pasien}}" readonly>
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        <label for="tanggal_pengobatan" class="col-sm-3 control-label">*Tanggal Follow Up</label>
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="tanggal_pengobatan" name="tanggal_pengobatan" value="{{$data->tanggal_pengobatan}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="rencana_kunjungan_selanjutnya" name="rencana_kunjungan_selanjutnya" value="{{$data->rencana_kunjungan_selanjutnya}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="berat_badan" name="berat_badan" placeholder="56.8" value="{{$data->berat_badan}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="tinggi_bedan" name="tinggi_bedan" placeholder="123" value="{{$data->tinggi_bedan}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class= "form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="id_status_fungsional" id="id_status_fungsional">
                                                @if(isset($data->id_status_fungsional))
                                                    <option value="{{$data->id_status_fungsional}}">{{$data->statusFungsional->nama}}</option>
                                                @endif
                                                @if(!isset($data->id_status_fungsional))
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="stadium_who" name="stadium_who" value="{{$data->stadium_who}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="hamil" id="hamil">
                                                <option value="{{$data->hamil}}">{{$data->hamil}}</option>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="metode_kb" name="metode_kb"value="{{$data->metode_kb}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class= "form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="id_infeksi_oportunistik" id="id_infeksi_oportunistik">
                                                @if(isset($data->id_infeksi_oportunistik))
                                                    <option value="{{$data->id_infeksi_oportunistik}}">{{$data->infeksiOportunistik->nama}}</option>
                                                @endif
                                                @if(!isset($data->id_infeksi_oportunistik))
                                                    <option value="">-- Pilih --</option>
                                                @endif 
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="obat_untuk_io" name="obat_untuk_io" value="{{$data->obat_untuk_io}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class= "form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="id_status_tb" id="id_status_tb">
                                                <option value="{{$data->id_status_tb}}">{{$data->statusTb->nama}}</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="ppk" id="ppk">
                                                <option value="{{$data->ppk}}">{{$data->ppk}}</option>
                                                <option value="Tidak">Tidak</option>
                                                <option value="Ya">Ya</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class= "form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="id_paduan_art" name="id_paduan_art">
                                                @if(isset($data->id_paduan_art))
                                                    <option value="{{$data->id_paduan_art}}">{{$data->paduanArt->nama}}</option>
                                                @endif
                                                @if(!isset($data->id_paduan_art))
                                                    <option value="">-- Pilih --</option>
                                                @endif 
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="dosis" name="dosis" value="{{$data->dosis}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class= "form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="id_adherence_art" name="id_adherence_art">
                                                @if(isset($data->id_adherence_art))
                                                    <option value="{{$data->id_adherence_art}}">{{$data->adherenceArt->nama}}</option>
                                                @endif
                                                @if(!isset($data->id_adherence_art))
                                                    <option value="">-- Pilih --</option>
                                                @endif        
                                    ...
                                    <div class= "form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="id_efek_samping" name="id_efek_samping">
                                                ...
                                                @if(isset($data->id_efek_samping))
                                                    <option value="{{$data->id_efek_samping}}">{{$data->efekSamping->nama}}</option>
                                                @endif
                                                @if(!isset($data->id_efek_samping))
                                                    <option value="">-- Pilih --</option>
                                                @endif 
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="jumlah_cd4" name="jumlah_cd4" value="{{$data->jumlah_cd4}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="viral_load" name="viral_load" placeholder="" value="{{$data->viral_load}}" maxlength="11" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control" id="hasil_lab" name="hasil_lab">{{$data->hasil_lab}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="diberi_kondom" id="diberi_kondom">
                                                <option value="{{$data->diberi_kondom}}">{{$data->diberi_kondom}}</option>
                                                <option value="Tidak">Tidak</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="rujuk_ke_spesialis" id="rujuk_ke_spesialis">
                                                <option value="{{$data->rujuk_ke_spesialis}}">{{$data->rujuk_ke_spesialis}}</option>
                                                <option value="Tidak">Tidak</option>
                                                <option value="Ya">Ya</option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="sisa_obat" name="sisa_obat" placeholder="3" value="{{$data->sisa_obat}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$(function () {
     ...
     $('#saveBtn').click(function (e) {
         ...
         $.ajax({
             ...
             url: "{{ route('konselor.followup.store') }}",
             type: "POST",
             dataType: 'json',
