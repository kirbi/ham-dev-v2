...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2 dflex justify-content-between">
            ...
            <div>
                <a href="/konselor/konselingHiv/download/{{$data->id_konseling_hiv}}" class="btn btn-secondary"><i class="fas fa-download"></i> Download</a>
                <a href="/konselor/konselingHiv/index" class="btn btn-primary"><i class="fas fa-home"></i> Home</a>
            </div>
        </div>
    </div>
</div>
    ...
    $(function() {
        ...
        $('#saveBtn1').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('konselor.kelompokResikoKonseling.add') }}",
                type: "POST",
                dataType: 'json',
        ...
        $('#editKelompokResikoKonseling').click(function() {
            ...
            $.get("{{ url('konselor/kelompokResikoKonseling/edit') }}" + '/' + id_kelompok_resiko_konseling, function(data) {
                console.log(data);
        ...
        $('#saveBtn2').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('konselor.infoTesHivKonseling.add') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
        ...
        $('#editInfoTesHivKonseling').click(function() {
            var id_kelompok_resiko_konseling = $(this).data('id');
            $.get("{{ url('konselor/infoTesHivKonseling/edit') }}" + '/' + id_kelompok_resiko_konseling, function(data) {
                console.log(data);
        ...
        $('#saveBtn3').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('konselor.kajianResikoHiv.add') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
        ...
        $('#editKajianResikoHiv').click(function() {
            ...
            $.get("{{ url('konselor/kajianResikoHiv/edit') }}" + '/' + id_kajian_resiko_hiv, function(data) {
                console.log(data);
        ...
        $('#saveBtn4').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('konselor.tesHivKonseling.add') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
        ...
        $('#editTesHivKonseling').click(function() {
            ...
            $.get("{{ url('konselor/tesHivKonseling/edit')}}" + '/' + id_tes_hiv_konseling, function(data) {
                console.log(data);
        ...
        $('#saveBtn5').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('konselor.rekapTesHivKonseling.add') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
        ...
        $('#editRekapTesHivKonseling').click(function() {
            ...
            $.get("{{ url('konselor/rekapTesHivKonseling/edit')}}" + '/' + id_rekap_tes_hiv_konseling, function(data) {
                console.log(data);
