        ...
        <div class="card">
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
                    <h2>Download Laporan KEGIATAN CHECK HIV</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body" id="filter">
                        <form id="checkHiv" name="checkHiv" method="post" enctype="multipart/form-data" action="/konselor/download/check-hiv"  class="form-horizontal">
                        @csrf    
                            <div class="row p-2">
