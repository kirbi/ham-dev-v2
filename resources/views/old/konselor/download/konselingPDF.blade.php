...
<html>
<head>
    <title>Download Laporan Pasien konseling </title>
    <style>
        table, th, td {
           border: 1px solid;
        }
        ...
        <tr style="border-bottom: double;">
            ...
            <td style="width:700px;text-align: center;border: none;">
                <div style="text-align: center;">
                    <h3 style="margin: 0px; font-size: 24px;">PASIEN KONSELING HIV TAHUN {{$tahun}}</h3>
        ...
        <table style="width: 100%; font-size:12px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 50px;">{{$data['tanggal_test']}}</td>
                    ...
                    <td style="width: 40px;">{{$data['kategori_penularan']}}</i></td>
