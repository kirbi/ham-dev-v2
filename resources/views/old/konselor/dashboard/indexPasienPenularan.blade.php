        ...
        <div class="card">
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
                    <h2>GRAFIK PASIEN ODHA BERDASARKAN PENULARAN</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="d-flex justify-content-center">
                            <h3 class="card-title">Pasien ODHA Berdasarkan Penularan </h3>
                        </div>
                    </div>
                    <div class="card-body">
...
<script type="text/javascript">
    $(function() {
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('konselor.dashboard.indexPasienPenularan') }}",
        ...
        $('.filter').click(function (e) {
            ...
            $.ajax({
                ...
                url: "{{ route('konselor.dashboard.indexPasienPenularan.filter') }}",
                type: "POST",
                dataType: 'json',
                success: function(response) {
                    salesChart.data.labels = response.data.label;
