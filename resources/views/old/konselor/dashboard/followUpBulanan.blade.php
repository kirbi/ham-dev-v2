                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="d-flex justify-content-center">
                            <h3 class="card-title">Follow Up ART Pasien + HIV <b class="tahun"></b></h3>
                        </div>
                    </div>
                    <div class="card-body">
...
<script type="text/javascript">
    $(function() {
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('konselor.dashboard.followUpBulanan') }}",
        ...
        $('.filter').click(function (e) {
            ...
            $.ajax({
                ...
                url: "{{ route('konselor.dashboard.followUpBulanan.filter') }}",
                type: "POST",
                dataType: 'json',
                success: function(response) {
                    salesChart.data.datasets[0].data = response.data.jumlah;
