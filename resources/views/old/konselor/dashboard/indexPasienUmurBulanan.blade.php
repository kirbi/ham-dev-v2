        ...
        <div class="card">
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
                    <h2>GRAFIK PASIEN ODHA BERDASARKAN KELOMPOK UMUR BERDASARKAN BULAN</h2>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('konselor.dashboard.indexPasienUmurBulanan') }}",
        ...
        $('.filter').click(function (e) {
            ...
            $.ajax({
                ...
                url: "{{ route('konselor.dashboard.indexPasienUmurBulanan.filter') }}",
                type: "POST",
                dataType: 'json',
                success: function(response) {
                    salesChart.data.datasets[0].data = response.data.satu;
