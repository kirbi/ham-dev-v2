...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2 dflex justify-content-between">
            ...
            <div>
                <a href="/admin/pasien/download/{{$data->id_pasien}}" class="btn btn-secondary"><i class="fas fa-download"></i> Download</a>
                <a href="/admin/pasien" class="btn btn-primary"><i class="fas fa-home"></i> Home</a>
            </div>
        </div>
    </div>
</div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">Indikasi Inisiasi ART
                                            <ul class="list-group list-group-unbordered mb-3">
                                                ...
                                                <li class="list-group-item">
                                                    <b>Tempat PDP</b> <a class="float-right">{{$data->tempat_pdp}}</a>
                                                </li>
                                                <li class="list-group-item">
                                        ...
                                        <ul class="list-group list-group-unbordered mb-3">
                                            @foreach($data->faktorResikoPasien as $fr)
                                                <li class="list-group-item">
                                                    ...
                                                    <a class="btn btn-success btn-sm btn-sm float-right editFaktorResiko" href="javascript:void(0)" id="editFaktorResiko" data-id="{{$fr->id_faktor_resiko_pasien}}"> <i class="fas fa-edit"></i></a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-sm float-right editMitraSeksual" href="javascript:void(0)" id="editMitraSeksual" data-id="{{$rms->id_riwayat_mitra_seksual}}" title="Ubah"><i class="fas fa-edit"></i></a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$pk->lain_lain}}</td>
                                            <td>
                                                <a class="btn btn-success btn-sm float-right editPemeriksaanKlinis" href="javascript:void(0)" id="editPemeriksaanKlinis" data-id="{{$pk->id_pemeriksaan_klinis}}" title="Ubah"><i class="fas fa-edit"></i></a>
                    ...
                    <div class="col-12">
                        <div class="card card-danger card-outline">
                            <div class="card-header">
                                ...
                                <a class="btn btn-success btn-sm float-right m-1" href="javascript:void(0)" id="createTerapiArt"> <i class="fas fa-plus"></i> Tambah Data</a>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-sm float-right editTerapiArt" href="javascript:void(0)" id="editTerapiArt" data-id="{{$ta->id_terapi_art_pasien}}" title="Ubah"><i class="fas fa-edit"></i></a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$pt->no_reg_tb}}</td>
                                            <td>
                                                <a class="btn btn-success btn-sm float-right editPengobatanTb" href="javascript:void(0)" id="editPengobatanTb" data-id="{{$pt->id_pengobatan_tb_hiv}}" title="Ubah"><i class="fas fa-edit"></i></a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-sm float-right editPasienFile m-2" href="javascript:void(0)" id="editPasienFile" data-id="{{$pf->id_file}}" title="Ubah"><i class="fas fa-edit"></i></a>
                                                <a class="btn btn-danger btn-sm float-right deletePasienFile m-2" href="javascript:void(0)" id="deletePasienFile" data-id="{{$pf->id_file}}" title="Hapus"> <i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        @endif
            ...
            <div class="modal-body">
                <form id="setPositifHiv" name="setPositifHiv" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="tanggal_konfirmasi_hiv" name="tanggal_konfirmasi_hiv" value="{{$data->tanggal_konfirmasi_hiv}}" required="">
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="setNegatifHiv" name="setNegatifHiv" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="status" class="col-sm-12 control-label">Apakah anda yakin mengubah status pasien ini menjadi Negatif? <span class="text-danger"><i>*Data pasien yang menyatakan positif akan dihapus.</i></span></label>
                    </div>
...
<div class="modal fade" id="ajaxModel9" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="pasienFile" action="{{ route('admin.pasienFile.add') }}" name="pasienFile" class="form-horizontal" enctype="multipart/form-data">
    ...
    $(function() {
        ...
        $('#saveBtn').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.riwayatTerapiArt.add') }}",
                type: "POST",
                dataType: 'json',
        ...
        $('body').on('click', '.editRiwayatTerapiArt', function() {
            ...
            $.get("{{ route('riwayatTerapiArt.index') }}" + '/' + id_riwayat_terapi_art + '/edit', function(data) {
        ...
        $('body').on('click', '.deleteRiwayatTerapiArt', function (){
            ...
            if(result){
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('riwayatTerapiArt.destroy', '/') }}"+'/'+product_id,
                    success: function (data) {
                        if($.isEmptyObject(data.error)){
                            $(".alert-success").css('display','block');
        ...
        $('#saveBtn2').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.riwayatMitraSeksual.add') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
        ...
        $('body').on('click', '.editMitraSeksual', function() {
            ...
            $.get("{{ route('riwayatMitraSeksual.index') }}" + '/' + id_riwayat_mitra_seksual + '/edit', function(data) {
                console.log(data);
                ...
                $('#nama').val(data.nama);
                $('#umur').val(data.umur);
                $('#umur_bulan').val(data.umur_bulan);
        ...
        $('body').on('click', '.deleteMitraSeksual', function (){
            ...
            console.log(id);
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('riwayatMitraSeksual.destroy', '/') }}"+'/'+id,
                    success: function (data) {
                        if($.isEmptyObject(data.error)){
                            $(".alert-success").css('display','block');
                            $('.success').html("Data Berhasil Dihapus.");
        ...
        $('#saveBtn3').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.pemeriksaanKlinis.add') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
        ...
        $('body').on('click', '.editPemeriksaanKlinis', function() {
            var id_riwayat_mitra_seksual = $(this).data('id');
            $.get("{{ route('pemeriksaanKlinis.index') }}" + '/' + id_riwayat_mitra_seksual + '/edit', function(data) {
                console.log(data);
        ...
        $('body').on('click', '.deletePemeriksaanKlinis', function (){
            ...
            if(result){
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('pemeriksaanKlinis.destroy', '/') }}"+'/'+id,
                    success: function (data) {
                        if($.isEmptyObject(data.error)){
                            $(".alert-success").css('display','block');
                            $('.success').html("Data Berhasil Dihapus.");
        ...
        $('body').on('click', '#editPositifHiv', function() {
            ...
            $.get("{{ route('pasien.index') }}" + '/' + id_pasien + '/edit', function(data) {
        ...
        $('#saveBtn6').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.terapiArtPasien.add') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
        ...
        $('body').on('click', '.editTerapiArt', function() {
            ...
            $.get("{{ route('terapiArtPasien.index') }}" + '/' + id_terapi_art_pasien + '/edit', function(data) {
                console.log(data);
        ...
        $('body').on('click', '.deleteTerapiArt', function (){
            ...
            if(result){
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('terapiArtPasien.destroy', '/') }}"+'/'+id,
                    success: function (data) {
                        if($.isEmptyObject(data.error)){
                            $(".alert-success").css('display','block');
                            $('.success').html("Data Berhasil Dihapus.");
        ...
        $('#saveBtn7').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.pengobatanTb.add') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
        ...
        $('body').on('click', '.editPengobatanTb', function() {
            var id_terapi_art_pasien = $(this).data('id');
            $.get("{{ route('pengobatanTb.index') }}" + '/' + id_terapi_art_pasien + '/edit', function(data) {
                console.log(data);
        ...
        $('body').on('click', '.deletePengobatanTb', function (){
            ...
            if(result){
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('pengobatanTb.destroy', '/') }}"+'/'+id,
                    success: function (data) {
                        if($.isEmptyObject(data.error)){
                            $(".alert-success").css('display','block');
                            $('.success').html("Data Berhasil Dihapus.");
        ...
        $('#saveBtn8').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.faktorResikoPasien.add') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
        ...
        $('body').on('click', '.editFaktorResiko', function() {
            ...
            $.get("{{ route('faktorResikoPasien.index') }}" + '/' + id_faktor_resiko_pasien + '/edit', function(data) {
                console.log(data);
        ...
        $('body').on('click', '.deleteFaktorResiko', function (){
            ...
            if(result){
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('faktorResikoPasien.destroy', '/') }}"+'/'+id,
                    success: function (data) {
                        if($.isEmptyObject(data.error)){
                            $(".alert-success").css('display','block');
                            $('.success').html("Data Berhasil Dihapus.");
        ...
        $('#pasienFile').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: "{{ route('admin.pasienFile.add') }}",
                type: "POST",
        ...
        $('body').on('click', '.editPasienFile', function() {
            ...
            $.get("{{ route('pasienFile.index') }}" + '/' + id_file + '/edit', function(data) {
                console.log(data);
        ...
        $('body').on('click', '.deletePasienFile', function (){
            var id_file = $(this).data('id');
            var result = confirm("Apakah Anda yakin menghapus data FILE ini?");
            if(result){
                $.ajax({
                    type: "DELETE",
                    url: "{{ url('admin/pasienFile/delete', '/') }}" + '/' + id_file,
                    success: function (data) {
                        if($.isEmptyObject(data.error)){
                            $(".alert-success").css('display', 'block');
                            $('.success').html("Data Berhasil Dihapus.");
