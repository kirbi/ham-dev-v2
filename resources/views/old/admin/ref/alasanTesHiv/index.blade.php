            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_alasan_tes_hiv" id="id_alasan_tes_hiv">
...
$(function () {
     ...
     $('body').on('click', '.editProduct', function () {
         var id_alasan_tes_hiv = $(this).data('id');
         $.get("{{ route('alasanTesHiv.index') }}" +'/' + id_alasan_tes_hiv +'/edit', function (data) {
             $('#modelHeading').html("Ubah Data");
             $('#saveBtn').val("edit-user");
             $('#ajaxModel').modal('show');
             $('#nama').val(data.nama);
             $('#id_alasan_tes_hiv').val(data.id_alasan_tes_hiv);
         })
     });
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('alasanTesHiv.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
