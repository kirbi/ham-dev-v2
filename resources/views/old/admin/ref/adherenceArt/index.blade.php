            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_adherence_art" id="id_adherence_art">
...
$(function () {
     ...
     $('body').on('click', '.editProduct', function () {
         var id_adherence_art = $(this).data('id');
         $.get("{{ route('adherenceArt.index') }}" +'/' + id_adherence_art +'/edit', function (data) {
             $('#modelHeading').html("Ubah Data");
             $('#saveBtn').val("edit-user");
             $('#ajaxModel').modal('show');
             $('#nama').val(data.nama);
             $('#id_adherence_art').val(data.id_adherence_art);
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('adherenceArt.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
