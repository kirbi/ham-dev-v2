            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_kelompok_resiko" id="id_kelompok_resiko">
...
$(function () {
     ...
     var table = $('.data-table').DataTable({
         processing: true,
         serverSide: true,
         ajax: "{{ route('kelompokResiko.index') }}",
         columns: [
     ...
     $('body').on('click', '.editProduct', function () {
         var id_kelompok_resiko = $(this).data('id');
         $.get("{{ route('kelompokResiko.index') }}" +'/' + id_kelompok_resiko +'/edit', function (data) {
     ...
     $('#saveBtn').click(function (e) {
         ...
         $.ajax({
             ...
             url: "{{ route('kelompokResiko.store') }}",
             type: "POST",
             dataType: 'json',
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('kelompokResiko.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
