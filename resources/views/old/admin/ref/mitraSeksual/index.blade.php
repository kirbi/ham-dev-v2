            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_mitra_seksual" id="id_mitra_seksual">
...
$(function () {
     ...
     $('body').on('click', '.editProduct', function () {
         var id_mitra_seksual = $(this).data('id');
         $.get("{{ route('mitraSeksual.index') }}" +'/' + id_mitra_seksual +'/edit', function (data) {
             $('#modelHeading').html("Ubah Data");
             $('#saveBtn').val("edit-user");
             $('#ajaxModel').modal('show');
             $('#nama').val(data.nama);
             $('#id_mitra_seksual').val(data.id_mitra_seksual);
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('mitraSeksual.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
