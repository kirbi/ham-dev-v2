...
$(function () {
     ...
     var table = $('.data-table').DataTable({
         processing: true,
         serverSide: true,
         ajax: "{{ route('statusPernikahan.index') }}",
         columns: [
     ...
     $('body').on('click', '.editProduct', function () {
         var id_status_pernikahan = $(this).data('id');
         $.get("{{ route('statusPernikahan.index') }}" +'/' + id_status_pernikahan +'/edit', function (data) {
     ...
     $('#saveBtn').click(function (e) {
         ...
         $.ajax({
             ...
             url: "{{ route('statusPernikahan.store') }}",
             type: "POST",
             dataType: 'json',
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('statusPernikahan.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
