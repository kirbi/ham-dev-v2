...
<!-- Modal -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        <input type="hidden" name="id_check_hiv" id="id_check_hiv">
                        <div class="form-group row">
                            <label for="nama_kegiatan" class="col-sm-3 control-label">Nama</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan" placeholder="Nama Kegiatan" value="" maxlength="250" required="">
                            </div>
                        </div>
                        <div class= "form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea id="deskripsi_kegiatan" name="deskripsi_kegiatan" required="" placeholder="Deskripsi" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="nama_tempat" class="col-sm-3 control-label">Nama Tempat</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama_tempat" name="nama_tempat" placeholder="Cafe ....." value="" maxlength="250" required="">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="hadir" class="col-sm-3 control-label">Jumlah Hadir</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="hadir" name="hadir" value="" required="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="jumlah_positif" class="col-sm-3 control-label">Jumlah Positif</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="jumlah_positif" name="jumlah_positif" value="" required="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="jumlah_negatif" class="col-sm-3 control-label">Jumlah Negatif</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="jumlah_negatif" name="jumlah_negatif" value="" required="">
                            </div>
                        </div>
                        <div class="form-group row">
    ...
    <div class="modal fade" id="ajaxModel2" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Detail Kegiatan Check HIV</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
    ...
    $('.select2').select2();
     ...
     var table = $('.data-table').DataTable({
         ...
         columns: [
             ...
             {data: 'jumlah_negatif', name: 'jumlah_negatif'},
     ...
     $('body').on('click', '.editProduct', function () {
         var id_check_hiv = $(this).data('id');
         $.get("{{ route('checkHiv.index') }}" +'/' + id_check_hiv +'/edit', function (data) {
             $('#modelHeading').html("Ubah Data");
             $('#saveBtn').val("edit-user");
             $('#ajaxModel').modal('show');
             $('#id_check_hiv').val(data.id_check_hiv);
             ...
             $('#jumlah_negatif').val(data.jumlah_negatif);
             $('#jumlah_positif').val(data.jumlah_positif);
     ...
     $('body').on('click', '.detailProduct', function () {
         var id_check_hiv = $(this).data('id');
         $.get("{{ route('checkHiv.index') }}" +'/' + id_check_hiv +'/edit', function (data) {
            console.log(data.nama_narahubung);
             $('#dnama_kegiatan').html(data.nama_kegiatan);
             $('#ddeskripsi_kegiatan').html(data.deskripsi_kegiatan);
             $('#dnama_tempat').html(data.nama_tempat);
             $('#dtanggal_kegiatan').html(data.tanggal_kegiatan);
             $('#dhadir').html(data.hadir);
             $('#djumlah_negatif').html(data.jumlah_negatif);
             $('#djumlah_positif').html(data.jumlah_positif);
     ...
     $('body').on('click', '.deleteProduct', function (){
         ...
         if(result){
             $.ajax({
                 type: "DELETE",
                 url: "{{ route('checkHiv.store') }}"+'/'+product_id,
                 success: function (data) {
                    if($.isEmptyObject(data.error)){
                        $(".alert-success").css('display','block');
