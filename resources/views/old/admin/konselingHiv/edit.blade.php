                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row dflex justify-content-center">
                            <h5>Tambah Data Konseling Pasien "{{$data->pasien->nama}}"</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <form id="konselingForm" name="konselingForm" class="form-horizontal">
                            ...
                            <input type="hidden" name="id_konseling_hiv" id="id_konseling_hiv" value="{{$data->id_konseling_hiv}}" readonly>
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        <label for="no_registrasi" class="col-sm-3 control-label">No Registrasi</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="no_registrasi" name="no_registrasi" placeholder="56-34-3234-32" value="{{$data->no_registrasi}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class= "form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="id_status_pernikahan" id="id_status_pernikahan">
                                                <option value="{{$data->id_status_pernikahan}}">{{$data->statusPernikahan->nama}}</option>
                                                <?php
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="id_pendidikan" id="id_pendidikan">
                                                <option value="{{$data->id_pendidikan}}">{{$data->pendidikan->nama}}</option>
                                                <?php
                                    ...
                                    <div class= "form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="id_pekerjaan" id="id_pekerjaan">
                                                <option value="{{$data->id_pekerjaan}}">{{$data->pekerjaan->nama}}</option>
                                                <?php
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="ada_pasangan_perempuan" id="ada_pasangan_perempuan">
                                                    <option value="{{$data->ada_pasangan_perempuan}}">{{$data->ada_pasangan_perempuan}}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="pasangan_hamil" id="pasangan_hamil">
                                                    <option value="{{$data->pasangan_hamil}}">{{$data->pasangan_hamil}}</option>
                                                    <option value="Tidak">Tidak</option>
                                                    <option value="Ya">Ya</option>
                                                </select>
                                            </div>
                                ...
                                @if($data->pasien->jenis_kelamin =='Perempuan')
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" id="jumlah_pasangan_laki_laki" name="jumlah_pasangan_laki_laki" value="{{$data->jumlah_pasangan_laki_laki}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class= "form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="status_kehamilan" id="status_kehamilan">
                                                        <option value="{{$data->status_kehamilan}}">{{$data->status_kehamilan}}</option>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="jumlah_anak_kandung" name="jumlah_anak_kandung" value="{{$data->jumlah_anak_kandung}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="umur_anak_terakhir" name="umur_anak_terakhir" value="{{$data->umur_anak_terakhir}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="status_pasien" id="status_pasien">
                                                <option value="{{$data->status_pasien}}">{{$data->status_pasien}}</option>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="tanggal_konseling_pra_tes_hiv" name="tanggal_konseling_pra_tes_hiv"value="{{$data->tanggal_konseling_pra_tes_hiv}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="tanggal_konseling" name="tanggal_konseling" value="{{$data->tanggal_konseling}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="tanggal_konseling_pasca_tes_hiv" name="tanggal_konseling_pasca_tes_hiv"value="{{$data->tanggal_konseling_pasca_tes_hiv}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <option value="{{$data->pernah_tes_hiv_sebelumnya}}">{{$data->pernah_tes_hiv_sebelumnya}}</option>
                                                    <option value="Tidak">Tidak</option>
                                                    <option value="Ya">Ya</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class= "form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="id_alasan_tes_hiv" id="id_alasan_tes_hiv">
                                                <option value="{{$data->id_alasan_tes_hiv}}">{{$data->alasanTes->nama}}</option>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control" id="catatan_konseling" name="catatan_konseling">{{$data->catatan_konseling}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="kesediaan_tes_hiv" id="kesediaan_tes_hiv">
                                                <option value="{{$data->kesediaan_tes_hiv}}">{{$data->kesediaan_tes_hiv}}</option>
                                                <option value="Tidak">Tidak</option>
                                                <option value="Ya">Ya</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class= "form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="id_konselor" id="id_konselor">
                                                <option value="{{$data->id_konselor}}">{{$data->konselor->nama}}</option>
                                                <?php
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="row">
                                        ...
                                        <select class="form-control select2 col-7 col-sm-9" id="id_kabupaten" name="id_kabupaten">
                                                <option value="{{$data->id_kabupaten}}">{{$data->kabupaten->nama}}</option>
...
$(function () {
     ...
     $('#saveBtn').click(function (e) {
         ...
         $.ajax({
             ...
             url: "{{ route('admin.konselingHiv.store') }}",
             type: "POST",
             dataType: 'json',
