...
class DashboardController extends Controller
{
    ...
    public function indexPasienTahunan(Request $request)
    {
        ...
        return view('admin.dashboard.indexPasienTahunan', compact(
            'pekerjaan',
            'pendidikan',
            'statusPernikahan',
            'tahun',
    ...
    public function indexPasienHidupMati(Request $request)
    {
        ...
        return view('admin.dashboard.indexPasienHidupMati', compact(
            'tahun'
        ));
    }
    ...
    public function indexPasienPenularan(Request $request)
    {
        ...
        return view('admin.dashboard.indexPasienPenularan', compact(
            'tahun'
        ));
    }
    ...
    public function indexPasienTahunanPersentase(Request $request)
    {
        if ($request->ajax()) {
         ...
         return view('admin.dashboard.indexPasienTahunanPersentase', compact(
             'pekerjaan',
             'pendidikan',
             'statusPernikahan',
             'tahun',
    ...
    public function indexPasienUmur(Request $request)
    {
        ...
        if ($request->ajax()) {
         ...
         $tahun = Pasien::select(DB::raw('YEAR(tanggal_masuk) as tahun'))->where(['deleted' => 0])->orderBy('tanggal_masuk', 'desc')->distinct()->get();
         return view('admin.dashboard.indexPasienUmur', compact(
             'tahun'));
    }
    ...
    public function indexPasienUmurBulanan(Request $request)
    {
        ...
        $tahun = Pasien::select(DB::raw('YEAR(tanggal_masuk) as tahun'))->where(['deleted' => 0])->orderBy('tanggal_masuk', 'desc')->distinct()->get();
        return view('admin.dashboard.indexPasienUmurBulanan', compact(
            'tahun'
        ));
    }
    ...
    public function indexPasienBulanan(Request $request)
    {
        ...
        return view('admin.dashboard.indexPasienBulanan', compact(
            'pekerjaan',
            'pendidikan',
            'statusPernikahan',
            'tahun',
    ...
    public function followUpTahunan(Request $request)
    {
        ...
        return view('admin.dashboard.followUpTahunan', compact(
            'adherenceArt',
            'efekSamping',
            'infeksiOportunistik',
            'paduanArt',
    ...
    public function followUpBulanan(Request $request)
    {
        ...
        return view('admin.dashboard.followUpBulanan', compact(
            'adherenceArt',
            'efekSamping',
            'infeksiOportunistik',
            'paduanArt',
    ...
    public function checkHivBulanan(Request $request)
    {
        ...
        return view('admin.dashboard.checkHivBulanan', compact(
            'kabupaten',
            'tahun'
        ));
    }
    ...
    public function sosialisasiHivBulanan(Request $request)
    {
        ...
        $kabupaten = Kabupaten::orderBy('nama', 'ASC')->where(['deleted' => 0])->get();
        return view('admin.dashboard.sosialisasiHivBulanan', compact(
            'kabupaten',
            'tahun'
        ));
    }
    ...
    public function indexKonselingTahunan(Request $request)
    {
        ...
        return view('admin.dashboard.indexKonselingTahunan', compact(
            'tahun'
        ));
    }
    ...
    public function indexKonselingBulanan(Request $request)
    {
        ...
        return view('admin.dashboard.indexKonselingBulanan', compact(
            'tahun'
        ));
    }
