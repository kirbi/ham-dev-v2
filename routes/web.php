...
Route::middleware(['auth'])->group(function () {
    Route::get('/profil', App\Livewire\User\Profile::class)->name('user.profile');
});

// ─── Admin + Konselor routes ─────────────────────────────────────────────────
Route::middleware(['auth', 'role:admin,konselor'])->group(function () {
    ...
    Route::get('/pasien/create', App\Livewire\Pasien\Form::class)->name('pasien.create');
    Route::get('/pasien/{id}/edit', App\Livewire\Pasien\Form::class)->name('pasien.edit');
    ...
    Route::get('/check-hiv/{id}/edit', App\Livewire\CheckHiv\Form::class)->name('check-hiv.edit');

    // Sosialisasi HIV
    Route::get('/sosialisasi-hiv', App\Livewire\SosialisasiHiv\Index::class)->name('sosialisasi-hiv.index');
    Route::get('/sosialisasi-hiv/create', App\Livewire\SosialisasiHiv\Form::class)->name('sosialisasi-hiv.create');
    Route::get('/sosialisasi-hiv/{id}/edit', App\Livewire\SosialisasiHiv\Form::class)->name('sosialisasi-hiv.edit');
    ...
    Route::get('/konseling/create', App\Livewire\Konseling\Form::class)->name('konseling.create');
    ...
    // Follow-up Pasien
    Route::get('/follow-up', App\Livewire\FollowUp\Index::class)->name('follow-up.index');
    Route::get('/follow-up/create', App\Livewire\FollowUp\Form::class)->name('follow-up.create');
    Route::get('/follow-up/{id}/edit', App\Livewire\FollowUp\Form::class)->name('follow-up.edit');

    // Referensi — accessible by both admin and konselor
    ...
    Route::get('/reff-adherence-art/{id}/edit', App\Livewire\ReffAdherenceArt\Form::class)->name('reff-adherence-art.edit');
    ...
    Route::get('/reff-alasan-substitusi/{id}/edit', App\Livewire\ReffAlasanSubstitusi\Form::class)->name('reff-alasan-substitusi.edit');
    ...
    Route::get('/reff-efek-samping/{id}/edit', App\Livewire\ReffEfekSamping\Form::class)->name('reff-efek-samping.edit');
    ...
    Route::get('/reff-infeksi-oportunistik/{id}/edit', App\Livewire\ReffInfeksiOportunistik\Form::class)->name('reff-infeksi-oportunistik.edit');
    ...
    Route::get('/reff-paduan-art/{id}/edit', App\Livewire\ReffPaduanArt\Form::class)->name('reff-paduan-art.edit');
    ...
    Route::get('/reff-status-fungsional/{id}/edit', App\Livewire\ReffStatusFungsional\Form::class)->name('reff-status-fungsional.edit');
    ...
    Route::get('/reff-status-tb/{id}/edit', App\Livewire\ReffStatusTb\Form::class)->name('reff-status-tb.edit');
    ...
    Route::get('/reff-tipe-tb/{id}/edit', App\Livewire\ReffTipeTb\Form::class)->name('reff-tipe-tb.edit');
});

// ─── Admin-only routes ────────────────────────────────────────────────────────
Route::middleware(['auth', 'role:admin'])->group(function () {

    // Download pasien data
